 ...
 * <p>
 * The emulator used to carry this for everything it had ever heard of. These boards bring it
 * themselves, so a build that does not have them does not know about them either.
 */
public class MultifaceRoms implements RomsOfItsOwn {

  @Override
  public Map<String, List<String>> files() {
    return Map.ofEntries(
        Map.entry("MultifaceOnePeripheral", List.of("mf1.rom")),
        Map.entry("Multiface128Peripheral", List.of("mf128.rom")),
        Map.entry("Multiface3Peripheral", List.of("mf3.rom")));
  }
}
